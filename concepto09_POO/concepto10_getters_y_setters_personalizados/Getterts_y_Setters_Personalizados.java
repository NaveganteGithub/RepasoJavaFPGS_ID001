...
public class Getterts_y_Setters_Personalizados { // Esta es la clase que se utilizara para crear los objetos
	...
	/*
	 * Podemos crear Getters y Setters personalizados
	 * tal que solo haran su funcion correspondiente,
	 * si se cumplen con ciertos requisitos
	 * 
	 * */
	
	public int getDia(Object clase) {
		
		if(clase.getClass().getName().equals("conceptos.paso1_Basicos.concepto09_POO.concepto10_getters_y_setters_personalizados.Concepto9"))
			return dia;
	...
	public void setDia(int dia) {
		...
		if(this.dia != dia && dia < 32 && dia > 0) this.dia = dia;
		else if(this.dia == dia) System.out.println("El dia es el mismo introduce otro dia");
		else System.out.println("Introduce un dia correctamente");
	}
	...
	public Getterts_y_Setters_Personalizados() {
		super();
	}
	
	Getterts_y_Setters_Personalizados(GregorianCalendar f1) {
		super();
		this.f1 = f1;
	}
	
	protected Getterts_y_Setters_Personalizados(GregorianCalendar f1, GregorianCalendar f2) {
		super();
		this.f1 = f1;
		this.f2 = f2;
	}
